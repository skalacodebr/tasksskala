...
<div class="px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-purple-100">Acompanhe o status de todas as suas solicitações de correções e ajustes</p>
                </div>
    ...
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-xl font-semibold text-gray-900">Todas as Solicitações</h2>
        <a href="{{ route('cliente.criar-task') }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Projeto/Repositório</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <p class="text-sm font-medium text-gray-900">{{ Str::limit($task->task_description, 60) }}</p>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($task->repository_url)
                                        <div class="flex items-center text-sm">
                                            ...
                                            <span class="text-gray-600">{{ Str::limit(basename($task->repository_url), 30) }}</span>
                                        </div>
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('cliente.task.detalhes', $task->id) }}" class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-lg text-purple-700 bg-purple-100 hover:bg-purple-200 transition-colors">
    ...
    @else
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p class="text-gray-500 mb-6">Você ainda não criou nenhuma solicitação de correção ou ajuste</p>
            <a href="{{ route('cliente.criar-task') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                </svg>
