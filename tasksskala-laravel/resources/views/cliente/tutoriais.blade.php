        ...
        <div class="px-4 py-5 sm:p-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Aprenda como usar as funcionalidades do portal do cliente</p>
                </div>
    ...
    @else
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-8 sm:p-12 text-center">
                ...
                <p class="text-gray-600">Não há tutoriais disponíveis para clientes no momento.</p>
            </div>
        </div>
    @endif
</div>
