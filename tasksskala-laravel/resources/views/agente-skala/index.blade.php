...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm text-gray-600">Com Planos</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $tasks->filter(function($task) { return $task->plans->count() > 0; })->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm text-gray-600">Total Planos</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $tasks->sum(function($task) { return $task->plans->count(); }) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-xl font-semibold text-gray-900">Tasks do Agente</h2>
            <p class="text-sm text-gray-600 mt-1">Histórico de atividades e automações</p>
        </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-xs text-gray-500">Task #{{ $task->id }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($task->repository_url)
                                        <a href="{{ $task->repository_url }}" target="_blank" class="inline-flex items-center text-blue-600 hover:text-blue-800 text-sm">
        ...
        @else
            <div class="text-center py-12">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900">Nenhuma task encontrada</h3>
                <p class="mt-2 text-gray-500">O Agente Skala ainda não executou nenhuma task.</p>
            </div>
        @endif
    </div>
</div>
