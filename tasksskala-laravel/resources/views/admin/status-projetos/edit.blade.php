...
@section('title', 'Editar Status de Projeto')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Editar Status de Projeto</h3>
            
            <form action="{{ route('admin.status-projetos.update', $statusProjeto) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" id="nome" value="{{ old('nome', $statusProjeto->nome) }}" 
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-3">
                            <input type="color" name="cor" id="cor" value="{{ old('cor', $statusProjeto->cor) }}" 
                                   class="h-10 w-20 border border-gray-300 rounded cursor-pointer @error('cor') border-red-500 @enderror">
                            <input type="text" name="cor_text" id="cor_text" value="{{ old('cor', $statusProjeto->cor) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="ordem" id="ordem" value="{{ old('ordem', $statusProjeto->ordem) }}" 
                    ...
                    <div>
                        <div class="flex items-center">
                            <input type="checkbox" name="ativo" id="ativo" value="1" 
                                   ...
                                   {{ old('ativo', $statusProjeto->ativo) ? 'checked' : '' }}>
                    ...
                    <div>
                        ...
                        <textarea name="descricao" id="descricao" rows="3" 
                                  ...
                                  placeholder="Descreva quando este status deve ser usado...">{{ old('descricao', $statusProjeto->descricao) }}</textarea>
                        @error('descricao')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
