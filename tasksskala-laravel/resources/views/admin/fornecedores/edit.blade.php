...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Editar Fornecedor</h1>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="{{ route('admin.fornecedores.update', $fornecedor->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" value="{{ old('nome', $fornecedor->nome) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nome') border-red-500 @enderror">
                        @error('nome')
                    ...
                    <div>
                        ...
                        <select name="tipo_pessoa" id="tipo_pessoa" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('tipo_pessoa') border-red-500 @enderror">
                            ...
                            <option value="fisica" {{ old('tipo_pessoa', $fornecedor->tipo_pessoa) == 'fisica' ? 'selected' : '' }}>Pessoa Física</option>
                            <option value="juridica" {{ old('tipo_pessoa', $fornecedor->tipo_pessoa) == 'juridica' ? 'selected' : '' }}>Pessoa Jurídica</option>
                        </select>
                        @error('tipo_pessoa')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2">
                            <span id="label_documento">{{ $fornecedor->tipo_pessoa == 'fisica' ? 'CPF' : 'CNPJ' }}</span> <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="cpf_cnpj" id="cpf_cnpj" value="{{ old('cpf_cnpj', $fornecedor->documento) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('cpf_cnpj') border-red-500 @enderror">
                        @error('cpf_cnpj')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $fornecedor->email) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('email') border-red-500 @enderror">
                        @error('email')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $fornecedor->telefone) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('telefone') border-red-500 @enderror">
                        @error('telefone')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="celular" id="celular" value="{{ old('celular', $fornecedor->celular) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('celular') border-red-500 @enderror">
                        @error('celular')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="cep" id="cep" value="{{ old('cep', $fornecedor->cep) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('cep') border-red-500 @enderror">
                        @error('cep')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="endereco" id="endereco" value="{{ old('endereco', $fornecedor->endereco) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('endereco') border-red-500 @enderror">
                        @error('endereco')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="numero" value="{{ old('numero', $fornecedor->numero) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('numero') border-red-500 @enderror">
                        @error('numero')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="complemento" value="{{ old('complemento', $fornecedor->complemento) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('complemento') border-red-500 @enderror">
                        @error('complemento')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bairro" id="bairro" value="{{ old('bairro', $fornecedor->bairro) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('bairro') border-red-500 @enderror">
                        @error('bairro')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="cidade" id="cidade" value="{{ old('cidade', $fornecedor->cidade) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('cidade') border-red-500 @enderror">
                        @error('cidade')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="observacoes" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('observacoes') border-red-500 @enderror">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
                        @error('observacoes')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="ativo" value="1" {{ old('ativo', $fornecedor->ativo) ? 'checked' : '' }} class="mr-2">
