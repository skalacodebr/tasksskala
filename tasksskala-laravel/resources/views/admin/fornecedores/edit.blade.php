            ...
            <form method="POST" action="{{ route('admin.fornecedores.update', $fornecedor->id) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" value="{{ old('nome', $fornecedor->nome) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('nome') border-red-500 @enderror">
                        @error('nome')
                    ...
                    <div>
                        <label class="block text-muted-dark text-sm font-bold mb-2">
                            <span id="label_documento">{{ $fornecedor->tipo_pessoa == 'fisica' ? 'CPF' : 'CNPJ' }}</span>
                        </label>
                        <input type="text" name="cpf_cnpj" id="cpf_cnpj" value="{{ old('cpf_cnpj', $fornecedor->cpf_cnpj) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('cpf_cnpj') border-red-500 @enderror">
                        @error('cpf_cnpj')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $fornecedor->email) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('email') border-red-500 @enderror">
                        @error('email')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="telefone" id="telefone" value="{{ old('telefone', $fornecedor->telefone) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('telefone') border-red-500 @enderror">
                        @error('telefone')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="celular" id="celular" value="{{ old('celular', $fornecedor->celular) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('celular') border-red-500 @enderror">
                        @error('celular')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="cep" id="cep" value="{{ old('cep', $fornecedor->cep) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('cep') border-red-500 @enderror">
                        @error('cep')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="endereco" id="endereco" value="{{ old('endereco', $fornecedor->endereco) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('endereco') border-red-500 @enderror">
                        @error('endereco')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="numero" value="{{ old('numero', $fornecedor->numero) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('numero') border-red-500 @enderror">
                        @error('numero')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="complemento" value="{{ old('complemento', $fornecedor->complemento) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('complemento') border-red-500 @enderror">
                        @error('complemento')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bairro" id="bairro" value="{{ old('bairro', $fornecedor->bairro) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('bairro') border-red-500 @enderror">
                        @error('bairro')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="cidade" id="cidade" value="{{ old('cidade', $fornecedor->cidade) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('cidade') border-red-500 @enderror">
                        @error('cidade')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="observacoes" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-muted-dark leading-tight focus:outline-none focus:shadow-outline @error('observacoes') border-red-500 @enderror">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
                        @error('observacoes')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    </div>
