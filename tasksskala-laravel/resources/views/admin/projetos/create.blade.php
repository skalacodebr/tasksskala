                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="instrucoes_ambiente_teste" id="instrucoes_ambiente_teste" rows="4" placeholder="Ex: URL, usuário, senha, informações específicas para acesso ao ambiente de teste..."
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('instrucoes_ambiente_teste') border-red-500 @enderror">{{ old('instrucoes_ambiente_teste') }}</textarea>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="instrucoes_ambiente_producao" id="instrucoes_ambiente_producao" rows="4" placeholder="Ex: URL, usuário, senha, informações específicas para acesso ao ambiente de produção..."
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('instrucoes_ambiente_producao') border-red-500 @enderror">{{ old('instrucoes_ambiente_producao') }}</textarea>
