        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                @if($conta->status == 'pendente')
                    <button onclick="abrirModalReceber()" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-2">
                        Receber
                    </button>
                @endif
                <a href="{{ route('admin.contas-receber.edit', $conta->id) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded mr-2">
                    Editar
                </a>
                <a href="{{ route('admin.contas-receber.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                    Voltar
                </a>
            </div>
        </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div class="border-t border-gray-200">
                <dl>
                    ...
                    <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm font-medium text-gray-500">Data de Recebimento</dt>
                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $conta->data_recebimento->format('d/m/Y') }}</dd>
                    </div>
                    @endif
                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
