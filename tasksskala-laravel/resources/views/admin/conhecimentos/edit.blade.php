...
@section('title', 'Editar Conhecimento')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Editar Conhecimento</h3>
            
            <form action="{{ route('admin.conhecimentos.update', $conhecimento) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" id="nome" value="{{ old('nome', $conhecimento->nome) }}" 
                    ...
                    <div>
                        ...
                        <textarea name="descricao" id="descricao" rows="3" 
                                  ...
                                  placeholder="Descreva o que engloba este conhecimento, nível de expertise esperado, etc...">{{ old('descricao', $conhecimento->descricao) }}</textarea>
                        @error('descricao')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
