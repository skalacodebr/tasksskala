...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Editar Colaborador</h3>
            
            <form action="{{ route('admin.colaboradores.update', $colaborador) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" id="nome" value="{{ old('nome', $colaborador->nome) }}" 
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email', $colaborador->email) }}" 
                    ...
                    <!-- Senha -->
                    <div>
                        <label for="senha" class="block text-sm font-medium text-gray-700">Nova Senha (deixe em branco para manter a atual)</label>
                            ...
                            @foreach($conhecimentos as $conhecimento)
                                <div class="flex items-center mb-2">
                                    <input type="checkbox" name="conhecimentos[]" value="{{ $conhecimento->id }}" 
                                           ...
                                           {{ in_array($conhecimento->id, old('conhecimentos', $colaborador->conhecimentos->pluck('id')->toArray())) ? 'checked' : '' }}
