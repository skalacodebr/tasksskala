...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.importacao-ofx.create') }}?tipo_conta=pagar" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                <i class="fas fa-file-import mr-2"></i>Importar OFX
            </a>
            <a href="{{ route('admin.contas-pagar.create') }}" class="btn-primary-dark font-bold py-2 px-4 rounded">
                Nova Conta
            </a>
        </div>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-700 table-dark-custom">
            <thead class="bg-gray-800">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-muted-dark uppercase tracking-wider">Categoria</th>
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @if($conta->fornecedor_id && $conta->fornecedor)
                                <br><span class="text-xs text-muted-dark">{{ $conta->fornecedor->nome }}</span>
                            @elseif($conta->fornecedor)
                                <br><span class="text-xs text-muted-dark">{{ $conta->fornecedor }}</span>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($conta->categoria)
