...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Gerencie os tickets de suporte dos clientes</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            <div class="text-sm text-gray-500">Total de Tickets</div>
        </div>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow">
            <div class="text-2xl font-bold text-gray-900">{{ $stats['fechados'] }}</div>
            <div class="text-sm text-gray-700">Fechados</div>
        </div>
    </div>
    ...
    <div class="bg-white p-4 rounded-lg shadow mb-6">
        <form method="GET" action="{{ route('tickets.index') }}" class="flex flex-wrap gap-4">
            ...
            <select name="setor" onchange="this.form.submit()" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            @if(request()->anyFilled(['status', 'setor', 'prioridade']))
                <a href="{{ route('tickets.index') }}" class="text-sm text-gray-500 hover:text-gray-700">Limpar filtros</a>
            @endif
        </form>
    </div>
