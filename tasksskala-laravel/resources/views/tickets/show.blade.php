        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-gray-600">{{ $ticket->titulo }}</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white shadow rounded-lg p-6 mb-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Descrição</h2>
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    <h2 class="text-lg font-medium text-gray-900 mb-4">Histórico de Mensagens</h2>
                ...
                <div class="bg-white shadow rounded-lg p-6 mb-6">
                    ...
                    <dl class="space-y-3">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $ticket->setor_label }}</dd>
                        </div>
                        
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Cliente</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $ticket->cliente->nome }}</dd>
                        </div>
                        
                        @if($ticket->projeto)
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Projeto</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $ticket->projeto->nome }}</dd>
                        </div>
                        @endif
                        ...
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Respondido em</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $ticket->respondido_em->format('d/m/Y H:i') }}</dd>
                        </div>
                        @endif
                        
                        @if($ticket->fechado_em)
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Fechado em</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $ticket->fechado_em->format('d/m/Y H:i') }}</dd>
                        </div>
                        @endif
                    </dl>
                </div>
